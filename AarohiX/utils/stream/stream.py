...
import config
from AarohiX import Apple, Resso, SoundCloud, Spotify, Telegram, YouTube, app, YTB
from AarohiX.core.call import Hotty
...
from AarohiX.utils.pastebin import HottyBin
